...
const skillsByCategory = [
  {
    title: "Backend & APIs",
    description: "Building scalable services, APIs, and production-grade systems.",
    icon: Database,
    skills: [
      "Node.js",
      "NestJS",
  ...
  },
  {
    ...
    description: "Shipping AI-powered features and third-party integrations.",
    icon: Bot,
    skills: [
      "LangChain",
      "RAG",
  ...
  },
  {
    ...
    description: "Designing and optimizing data layers for production.",
    icon: Wrench,
    skills: [
      "PostgreSQL",
      "MongoDB",
